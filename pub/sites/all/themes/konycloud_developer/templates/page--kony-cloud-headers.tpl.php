 ...
 */
 ...
 $heading = $node->field_kony_cloud_headline['und'][0]['value'];
 $description = $node->body['und'][0]['value'];
 $bgimage = file_create_url($node->field_kony_cloud_bg_image['und'][0]['uri']);
 /* Node Fields Collection */
?>
<?php 
	//todo add check for if bgImage, add background color if it is entered
?>
		...
		<div id="intro-slider" class="flexslider panel" >
			<ul class="slides">
			   	<li>
					...
					<img class="bg-img" src="<?php print $bgimage; ?>" alt="<?php print $heading; ?>">
		    	</li>
		    </ul>
		</div>
...
<?php print render($page['views_content_region']); ?>

<?php if($page['recenttutorials']) { ?>
